...
interface StudentsOneProps {
  theme?: "light" | "dark"; // Pass theme prop
}

export default function StudentsOne({ theme = "light" }: StudentsOneProps) {
  return (
    <section
      className="relative -mt-[7%] py-9 w-[95%] mx-auto z-[5] rounded-lg overflow-hidden"
      aria-label="students-one"
    >
      {/* Left green/black background */}
      <div
        className="absolute inset-0 -z-10"
        style={{
          backgroundColor: theme === "dark" ? "#000000" : "#138c57",
          ...
          <div className="lg:col-span-7 text-white">
            ...
            <div className="flex items-center gap-6 group">
              ...
              <div>
                ...
                <div className="text-white/90 mt-1 text-5xl md:text-2xl">
                  Active Students
                </div>
              </div>
            </div>
