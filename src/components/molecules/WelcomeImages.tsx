...
export default function WelcomeImages() {
  return (
    <div className="relative flex justify-center items-center">
      ...
      <div className="absolute z-30 top-8 sm:top-11.5 h-[80%] w-2 sm:w-3 md:w-4 translate-x-[252px]" style={{ left: 'calc(50% - 75%)' }}>
      ...
      <div className="absolute bottom-0 left-4 sm:left-8 z-18">
        <div className="relative flex items-center gap-2 sm:gap-3 font-semibold text-sm sm:text-lg md:text-2xl text-black shadow-md px-4 sm:px-6 py-2 sm:py-4">
          {/* Ribbon background with inward tip */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#0D6832] to-[#FFD700] clip-ribbon rounded-md z-0"></div>

          {/* Icon and text */}
          <FaGlobe className="relative z-10 text-sm sm:text-xl md:text-2xl text-black" />
          <span className="relative z-10 text-xs sm:text-lg md:text-2xl text-black">
